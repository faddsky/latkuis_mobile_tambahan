class MovieModel {
  ...
  MovieModel({
    ...
    this.isBookmarked =
        false, // Secara default film belum di-bookmark saat aplikasi baru dibuka
  });
}
...
List<MovieModel> movieList = [
  MovieModel(
    ...
    price: 45000,
    lastReview: "Konsep mimpinya sangat luar biasa! Sangat merekomendasikan.",
  ),
  MovieModel(
    ...
    price: 35000,
    lastReview: "Sangat inspiratif, ending yang tidak terduga.",
  ),
  MovieModel(
    title: "Interstellar",
    year: 2014,
    ...
    price: 55000,
    lastReview: "Visual dan musiknya bikin merinding, mahakarya sesungguhnya.",
  ),
  MovieModel(
    ...
    price: 40000,
    lastReview: "Akting Heath Ledger sebagai Joker tidak ada tandingannya.",
  ),
  MovieModel(
    title: "Forrest Gump",
    year: 1994,
    ...
    price: 30000,
    lastReview:
        "Banyak pelajaran hidup yang bisa diambil, bikin nangis terharu.",
  ),
  MovieModel(
    title: "The Matrix",
    year: 1999,
    ...
    price: 38000,
    lastReview: "Film aksi Sci-Fi terbaik dengan konsep mind-blowing.",
  ),
  MovieModel(
    title: "The Godfather",
    year: 1972,
    ...
    price: 45000,
    lastReview: "Kisah mafia yang klasik dan sangat berkualitas.",
  ),
  MovieModel(
    title: "Titanic",
    year: 1997,
    ...
    price: 42000,
    lastReview: "Kisah romansa yang sangat emosional dan tragis.",
  ),
  MovieModel(
    title: "Pulp Fiction",
    year: 1994,
    ...
    price: 35000,
    lastReview: "Dialognya keren banget, plotnya juga unik karena acak.",
  ),
  MovieModel(
    title: "Avatar",
    year: 2009,
    ...
    price: 50000,
    lastReview: "Efek CGI yang sangat fenomenal!",
  ),
  MovieModel(
    ...
    price: 48000,
    lastReview: "Film fantasi paling epic sepanjang masa.",
  ),
  MovieModel(
    title: "Fight Club",
    year: 1999,
    ...
    price: 36000,
    lastReview: "Plot twist di akhirnya sangat tidak terduga!",
  ),
];
